...
CREATE TABLE skfp.`supply_master` (
...
CREATE TABLE skfp.`return_master` (
  `batch_id` int(10) unsigned DEFAULT NULL,
  `shop_id` int(10) unsigned DEFAULT NULL,
  `package_id` int(10) unsigned DEFAULT NULL,
  `quantity` smallint(5) unsigned DEFAULT NULL,
...
ALTER TABLE `skfp`.`supply_master` ADD FOREIGN KEY (`package_id`) REFERENCES `skfp`.`package_master`(`package_id`);
ALTER TABLE `skfp`.`supply_master` ADD FOREIGN KEY (`batch_id`) REFERENCES `skfp`.`batch_master`(`batch_id`);
ALTER TABLE `skfp`.`supply_master` ADD FOREIGN KEY (`shop_id`) REFERENCES `skfp`.`shop_master`(`shop_id`);
ALTER TABLE `skfp`.`batch_master` ADD FOREIGN KEY (`product_id`) REFERENCES `skfp`.`product_master`(`product_id`);
ALTER TABLE `skfp`.`return_master` ADD FOREIGN KEY (`package_id`) REFERENCES `skfp`.`package_master`(`package_id`);
ALTER TABLE `skfp`.`return_master` ADD FOREIGN KEY (`batch_id`) REFERENCES `skfp`.`batch_master`(`batch_id`);
ALTER TABLE `skfp`.`return_master` ADD FOREIGN KEY (`shop_id`) REFERENCES `skfp`.`shop_master`(`shop_id`);
...
ALTER TABLE skfp.`supply_master` ADD COLUMN (
  `status` tinyint(4) DEFAULT NULL,
  `created_by` varchar(21) DEFAULT NULL,
  `created_date` datetime DEFAULT NULL,
  `last_updated_by` varchar(21) DEFAULT NULL, 
...
ALTER TABLE skfp.`return_master` ADD COLUMN (
  `status` tinyint(4) DEFAULT NULL,
  `created_by` varchar(21) DEFAULT NULL,
  `created_date` datetime DEFAULT NULL,
  `last_updated_by` varchar(21) DEFAULT NULL, 
...
insert into skfp.batch_master(product_id,manufactured_date,quantity,status,created_by,created_date,last_updated_by,last_updated_date) values('3','2023-08-16','100','1','Santhosh',NOW(),'Santhosh',NOW());
insert into skfp.batch_master(product_id,manufactured_date,quantity,status,created_by,created_date,last_updated_by,last_updated_date) values('1','2023-08-16','100','1','Santhosh',NOW(),'Santhosh',NOW());
insert into skfp.batch_master(product_id,manufactured_date,quantity,status,created_by,created_date,last_updated_by,last_updated_date) values('4','2023-08-17','100','1','Santhosh',NOW(),'Santhosh',NOW());
insert into skfp.batch_master(product_id,manufactured_date,quantity,status,created_by,created_date,last_updated_by,last_updated_date) values('9','2023-08-17','100','1','Santhosh',NOW(),'Santhosh',NOW());
insert into skfp.batch_master(product_id,manufactured_date,quantity,status,created_by,created_date,last_updated_by,last_updated_date) values('8','2023-08-17','100','1','Santhosh',NOW(),'Santhosh',NOW());
